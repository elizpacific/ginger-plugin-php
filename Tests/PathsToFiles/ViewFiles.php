...
class ViewFiles
{
    private static $viewFiles = [
        ...
        'view/adminhtml/templates/info/klarnapaylater.phtml',
        ...
        'view/frontend/templates/info/klarnapaylater.phtml',
        ...
        'view/frontend/web/images/klarnapaylater.png',
        'view/frontend/web/images/klarnapaynow.png',
        ...
        'view/frontend/web/js/view/payment/method-renderer/klarnapaylater.js',
